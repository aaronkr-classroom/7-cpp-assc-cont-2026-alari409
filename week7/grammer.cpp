...
#include <cstdlib>	 //REND_MAX 정의
#include <stdexcept> //domain_error
#include <ctime>	 // time()...
//time()의 반환값은 1970년 1월 1일 00:00부터
//지금가지 건너뛴 시간 (ms) = 1675430097
...
#include "C:\c++\5주차\5-cpp-containers-2026-alari409\week5\split_str.h"

using namespace std;

typedef vector<string> Rule;
typedef vector<Rule> Rule_collection; //vevtor<vector<string>>
...
{
	//aaron.kr에 있는 grammer.txt 나 grammer-long.txt 필수
	Grammar ret;
	string line;
...
{
	//문법 파일 읽기.. 나중에
	// 현재 시간ㅇ로 난수 생성기를 초기화합니다. seed random
